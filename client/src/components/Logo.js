...
<div  className="flex items-center m-2">
  <svg className="w-12 h-12 mr-2 text-blue-500" viewBox="0 0 100 100">
  ...
  <div className="text-center">
    <h1 className="-ml-10 text-2xl font-bold text-white">StayEase</h1>
    <p className="text-sm text-gray-700">Find your perfect stay</p>
  </div>
</div>
