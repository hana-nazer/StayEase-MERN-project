...
import styles from "../stylesheets/success.module.css";
  ...
  return (
    <>
      <div className={styles.container}>
        <div className={`${styles.sub_container} flex-col border w-1/2  rounded-xl shadow-lg`}>
          <div>
            <p className="p-8 mb-4 text-5xl font-bold tracking-wide text-gray-700 font-oswald">
              Enjoy your holidays
            </p>
          </div>
          <div className={styles.checkmark}>
            ...
            <svg
              className={styles.checkmark__background}
              height="115"
              viewBox="0 0 120 115"
              width="120"
              xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="mt-7">
            <p className="mx-5 text-xl font-semibold text-center">
              Your resort booking has been successfully confirmed. We look
